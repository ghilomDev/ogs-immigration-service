          ...
          >
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="custom-accordion-item">
                <AccordionTrigger 
                  className="text-lg font-semibold text-gray-900 py-4 px-4 text-left custom-accordion-trigger"
                >
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent 
                  className="px-4 text-gray-600 text-left custom-accordion-content"
                >
                  <div className="py-3">
