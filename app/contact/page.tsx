    ...
    <>
      ...
      <section className="py-16 bg-gray-50" aria-labelledby="contact-heading">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 id="contact-heading" className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Get in Touch With Us</h1>
      ...
      {/* General FAQ Section */}
      <FAQSection 
        title={contactFAQData.title}
        faqs={contactFAQData.faqs}
      />
