import { Shield, Users, CheckCircle, Phone, FileText, Languages, Plane, Building, Heart, Award } from "lucide-react";
...
export const whyChooseUsData = {
  ...
  features: [
    ...
    },
    {
      ...
      description: "Hundreds of successful cases with high approval rates across all service areas.",
    },
    {
      icon: Phone,
  ...
  services: [
    {
      ...
      description: "Comprehensive assistance with all types of USCIS forms, ensuring accuracy and completeness for optimal application success.",
    },
    {
      icon: Shield,
      title: "Dedicated Asylum Support",
      description: "Expert guidance and advocacy for asylum seekers, offering compassionate guidance and expertise throughout the complex procedures.",
    },
    {
      icon: Languages,
      title: "Certified Translations",
      description: "Accurate and certified translation services for all official documents, recognized by immigration authorities.",
    },
    {
      icon: Plane,
      title: "Visa Application Expertise",
      description: "Thorough support for various visa applications, from tourist to employment-based visas, ensuring compliance with all requirements.",
    },
    {
      icon: Users,
      title: "Personalized Consultations",
      description: "One-on-one consultations tailored to your specific situation, providing personalized strategies and clear next steps.",
    },
    {
      icon: Phone,
      title: "Responsive Communication",
      description: "Clear and timely communication throughout your case, keeping you informed and confident throughout the process.",
    },
  ],
};
...
export const additionalServicesData = [
  {
    ...
    description: "Uniting families through precise application support for spouse, parent, and child visas.",
    link: "/services/family"
  },
  {
    iconName: "Building",
    title: "Employment Visas",
    description: "Navigating work-based immigration options for professionals, skilled workers, and investors.",
    link: "/services/employment"
  },
  {
    iconName: "Award",
    title: "Citizenship & Naturalization",
    description: "Complete support for the naturalization process, from eligibility assessment to oath ceremony.",
...
export const detailedServicesData = [
  {
    ...
    badgeColor: "green",
    description: "Expert assistance with a wide range of USCIS forms, ensuring accuracy and timely submission for a smooth application process.",
    features: [
  ...
  },
  {
    ...
    badgeColor: "orange",
    description: "Guidance through various visa application processes, from family-based to employment visas, ensuring compliance.",
    features: [
  ...
  steps: [
    {
      ...
      description: "We start with a comprehensive consultation to understand your unique situation and immigration goals."
    },
    {
      number: 2,
      title: "Strategy Development",
      description: "We develop a personalized strategy and timeline tailored to your specific case requirements."
    },
    {
      number: 3,
      title: "Document Preparation",
      description: "We meticulously prepare all necessary documentation and forms with attention to every detail."
    },
    {
      number: 4,
      title: "Ongoing Support",
      description: "We provide continuous support throughout the process, keeping you informed every step of the way."
    }
  ]
};
  ...
  steps: [
    {
      ...
      description: "Book a confidential consultation to discuss your immigration goals and assess your case.",
    },
    {
      number: 2,
    ...
    },
    {
      ...
      description: "Your application is submitted, and we monitor progress while keeping you informed.",
    },
    {
      number: 4,
      title: "Successful Resolution",
      description: "We work tirelessly towards a favorable outcome and celebrate your success with you.",
    },
  ],
};
...
export const testimonialsData = {
  ...
  testimonials: [
    {
      content: "\"OGS Immigration Services provided exceptional support during my green card application. Their expertise and attention to detail were truly remarkable. I highly recommend them!\"",
      name: "Aisha K.",
      role: "Green Card Recipient",
      rating: 5,
    },
    {
      content: "\"Mogos R. and his team made my asylum process feel less daunting. Their compassion and professional guidance were invaluable. Thank you for everything!\"",
      name: "Carlos M.",
      role: "Asylum Case",
      rating: 4,
    },
    {
      content: "\"Professional, knowledgeable, and caring. OGS helped me reunite with my family through the family-based immigration process. Forever grateful!\"",
      name: "Maria S.",
...
export const aboutTestimonialsData = {
  ...
  testimonials: [
    {
      content: "\"I received amazing help with my asylum application. Mogos R. explained every step clearly and made the process so smooth. Highly recommended!\"",
      name: "Mekdes T.",
      role: "Asylum Application",
      rating: 5,
    },
    {
      content: "\"The translation and notary services were fast and accurate. I used the documents for my USCIS interview with no issues. Thank you!\"",
      name: "Abel H.",
      role: "Document Translation",
      rating: 4,
    },
    {
      content: "\"Mogos and his team helped me apply for my mom's green card. They were professional, kind, and always available. I'm very grateful!\"",
      name: "Selam B.",
      role: "Family-Based Immigration",
      rating: 5,
    },
    {
      content: "\"I needed interpretation for my immigration case. The service was on time, professional, and respectful. Excellent support!\"",
      name: "Tesfay G.",
      role: "Interpretation Services",
      rating: 4,
    },
    {
      content: "\"I trusted them with my adjustment of status, and I'm so glad I did. Everything was done perfectly. They care about their clients!\"",
      name: "Hanna A.",
      role: "Adjustment of Status",
      rating: 5,
    },
    {
      content: "\"OGS Immigration Services made my complex immigration case feel manageable. Mogos R. and his team were incredibly knowledgeable and provided clear guidance throughout the entire process.\"",
      name: "Maria S.",
      role: "Family-Based Immigration",
      rating: 4,
    },
...
export const ctaData = {
  ...
  description: "Contact us today for a personalized consultation and let us help you achieve your immigration dreams.",
...
export const servicesCTAData = {
  ...
  description: "Contact us today for a personalized consultation and let us guide you through every step.",
  buttons: [
    {
    ...
    },
    {
      ...
      className: "border-white text-black hover:bg-white hover:text-[#5046E5] px-8 py-3 text-lg"
    }
  ]
};
  ...
  values: [
    {
      ...
      description: "Understanding the human stories and treating every client with dignity and understanding the unique challenges they face."
    },
    {
      icon: Award,
      title: "Expertise & Precision",
      description: "Delivering the highest quality legal advice and meticulous attention to detail in every case we handle."
    },
    {
      icon: CheckCircle,
      title: "Clarity & Simplicity",
      description: "Simplifying complex immigration processes and providing clear communication throughout your journey."
    }
  ]
};
  ...
  faqs: [
    {
      ...
      answer: "We provide comprehensive immigration services including USCIS form preparation, asylum case support, certified document translation, visa assistance, family-based immigration, and employment visa support."
    },
    {
      question: "How can I book a consultation?",
      answer: "You can book a consultation by calling us at (571) 351-3940, emailing us at openglobesolutions@gmail.com, or using the contact form above. We offer both in-person and virtual consultations."
    },
    {
      question: "Do you offer services for all immigration types?",
      answer: "Yes, we handle a wide range of immigration cases including family-based petitions, employment visas, asylum cases, naturalization, and various USCIS forms. Contact us to discuss your specific needs."
    },
    {
      question: "What languages do you speak?",
      answer: "Our team is multilingual and can assist clients in various languages. We also provide certified translation services for documents in multiple languages."
    }
  ]
};
...
export const uscisTranslationFAQData = {
  ...
  faqs: [
    ...
    {
      question:
        "What makes your USCIS form preparation service different from online DIY options?",
      answer:
...
export const scheduleHeroContent = {
  ...
  description: "Book a consultation with our immigration experts to get personalized guidance on your immigration needs.",
